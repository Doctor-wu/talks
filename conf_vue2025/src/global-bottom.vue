...
<template>
  ...
  >
    <div
      class="clip bg-gradient-to-r from-[#5ec5c2] to-white/10"
      :style="{ 'clip-path': `polygon(${poly1})`, 'opacity': opacity }"
    />
    <div
      class="clip bg-gradient-to-l from-[#e06e6e] to-white/10"
      :style="{ 'clip-path': `polygon(${poly2})`, 'opacity': opacity }"
    />
    <div
      class="clip bg-gradient-to-t from-[#6e62c2] to-white/10"
